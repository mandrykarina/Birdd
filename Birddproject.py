...
# birdsound2 = pygame.mixer.Sound("sounds/bumm.mp3")
birdsound3 = pygame.mixer.Sound("sounds/clickk.mp3")
...
notsoundbtn = pygame.image.load('images/notsound.png')
...
def second_page():
    global skyfon, junfon, desfon, music
...
notsoundbtn = Btn(80, 430, notsoundbtn)
